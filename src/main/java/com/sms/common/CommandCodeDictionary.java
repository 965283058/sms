...
public class CommandCodeDictionary
{
	...
	static
	{
		...
		commandCodeMap.put(CommandCode.INFORMATION_TYPE_NOT_EXIST,"通知类型名称不能为。");
		...
		commandCodeMap.put(CommandCode.EMPTY_COURSEWARE_NAME,"课件名称不能为空。");
		commandCodeMap.put(CommandCode.COURSEWARE_NOT_EXIST,"该课件不存在。");
		commandCodeMap.put(CommandCode.PAYMENT_NOT_EXIST, "该交易不存在。");
