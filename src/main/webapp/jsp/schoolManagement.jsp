...
<title>School Management Page</title>
...
<script type="text/javascript" src="<%=basePath%>js/school-management.js"></script>
</head>
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<div class="row operation-toolbar">
							<div class="col-6">
								<span class="far fa-list-alt"></span> 幼儿园列表
							</div>
							<div class="btn-group col-6 justify-content-end">
								<button type="button" class="btn btn-secondary btn-sm" id="add_btn" data-permission="add" onclick="editSchool(OperationType.ADD)">
									<span class="fas fa-pencil-alt"></span> 新建
								</button>
								<button type="button" class="btn btn-secondary btn-sm" id="edit_btn" data-permission="update" onclick="editSchool(OperationType.UPDATE)">
									<span class="fas fa-pencil-alt"></span> 修改
								</button>
								<button type="button" class="btn btn-secondary btn-sm" id="delete_btn" data-permission="delete" onclick="editSchool(OperationType.DELETE)">
									<span class="fas fa-pencil-alt"></span> 删除
								</button>
								<button type="button" class="btn btn-secondary btn-sm" id="view_btn" data-permission="view" onclick="editSchool(OperationType.VIEW)">
					...
					<div class="panel-body">
						<div class="row query-form justify-content-end">
							<form action="javascript:void(0);" class="form-inline" style="margin-bottom:1px;">
								<label class="mr-sm-2 mb-0" for="school_name_input">幼儿园名称</label> 
								<input type="text" class="form-control mr-sm-2 mb-2 mb-sm-0" id="school_name_input" name="school_name">
