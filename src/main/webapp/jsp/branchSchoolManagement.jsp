...
<title>Branch School Management Page</title>
...
<script type="text/javascript" src="<%=basePath%>js/branch-school-management.js"></script>
</head>
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<div class="row query-form">
							<form action="javascript:void(0);" class="form-inline" style="margin-bottom:1px;">
								...
								<label class="mr-sm-2 mb-0" for="branch_school_name_input">分园名称</label> 
								<input type="text" class="form-control mr-sm-2 mb-2 mb-sm-0" id="branch_school_name_input" name="branch_school_name">
					...
					<div class="panel-body">
						<div class="row operation-toolbar">
							<div class="col-6">
								<span class="far fa-list-alt"></span> 分园列表
							</div>
							<div class="btn-group col-6 justify-content-end">
								<button type="button" class="btn btn-secondary btn-sm" id="add_btn" data-permission="add" onclick="editBranchSchool(OperationType.ADD)">
									<span class="fas fa-pencil-alt"></span> 新建
								</button>
								<button type="button" class="btn btn-secondary btn-sm" id="edit_btn" data-permission="update" onclick="editBranchSchool(OperationType.UPDATE)">
									<span class="fas fa-pencil-alt"></span> 修改
								</button>
								<button type="button" class="btn btn-secondary btn-sm" id="delete_btn" data-permission="delete" onclick="editBranchSchool(OperationType.DELETE)">
									<span class="fas fa-pencil-alt"></span> 删除
								</button>
								<button type="button" class="btn btn-secondary btn-sm" id="view_btn" data-permission="view" onclick="editBranchSchool(OperationType.VIEW)">
									<span class="fas fa-pencil-alt"></span> 查看
								</button>
							</div>
						</div>
						
						<table id="branch_school_table"></table>
					</div>
				</div>
			</div>
		</div>
