...
<script type="text/javascript" src="<%=basePath%>js/group-leader-management.js"></script>
</head>
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<div class="row query-form">
							<form action="javascript:void(0);" class="form-inline" style="margin-bottom:1px;">
								...
								<label class="mr-sm-2 mb-0" for="user_name_input">班主任姓名</label> 
					...
					<div class="panel-body">
						<div class="row operation-toolbar">
							<div class="col-6">
								<span class="far fa-list-alt"></span> 班主任列表
							</div>
							<div class="btn-group col-6 justify-content-end">
								<button type="button" class="btn btn-secondary btn-sm" id="add_btn" data-permission="add" onclick="editGroupLeader(OperationType.ADD)">
									<span class="fas fa-pencil-alt"></span> 新建
								</button>
								<button type="button" class="btn btn-secondary btn-sm" id="edit_btn" data-permission="update" onclick="editGroupLeader(OperationType.UPDATE)">
									<span class="fas fa-pencil-alt"></span> 修改
								</button>
								<button type="button" class="btn btn-secondary btn-sm" id="disable_btn" data-permission="disable" onclick="editGroupLeader(OperationType.DISABLE)">
									<span class="fas fa-pencil-alt"></span> 禁用
								</button>
								<button type="button" class="btn btn-secondary btn-sm" id="delete_btn" data-permission="delete" onclick="editGroupLeader(OperationType.DELETE)">
									<span class="fas fa-pencil-alt"></span> 删除
								</button>
								<button type="button" class="btn btn-secondary btn-sm" id="view_btn" data-permission="view" onclick="editGroupLeader(OperationType.VIEW)">
									<span class="fas fa-pencil-alt"></span> 查看
								</button>
							</div>
						</div>
						
						<table id="group_leader_table"></table>
					</div>
				</div>
			</div>
		</div>
